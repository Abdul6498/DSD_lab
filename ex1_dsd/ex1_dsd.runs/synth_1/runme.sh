...
HD_PWD='E:/INFOTECH/First Semester/Digital system design/Xilinx/ex1_dsd/ex1_dsd.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log prior_enc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source prior_enc.tcl
