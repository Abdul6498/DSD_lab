...
HD_PWD='E:/INFOTECH/First Semester/Digital system design/Xilinx/ex_1_Dsd_mux/ex_1_Dsd_mux.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log comp_mux.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source comp_mux.tcl
