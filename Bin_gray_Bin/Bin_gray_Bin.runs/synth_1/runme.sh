...
HD_PWD='E:/INFOTECH/First Semester/Digital system design/Xilinx/Bin_gray_Bin/Bin_gray_Bin.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Bin_gray_bin.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Bin_gray_bin.tcl
